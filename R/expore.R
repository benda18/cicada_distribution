...
not.counties <- rbind(data.frame(state = "OH", 
                      ...
                      data.frame(state = "MS", 
                                 conam = c("Sunflower", "Washington", "Sharkey", "Walthall", 
                                           ...
                                           "Itawamba", "Jackson", "Cumberland", "Sequatchie", 
                                           "Van Buren", "Meigs")),
                      data.frame(state = "TN",
                      ...
                      data.frame(state = "VA", 
                                 conam = c("Scott", "Russell", "Washington", 
                                           "Bristol", "Henry", "Martinsville", 
                                           "Halifax", "Mecklenburg", "Greensville", 
                                           "Dinwiddie", "Nottoway", "Amelia", "Cumberland", 
                                           "Chesterfield", "Petersburg", "Colonial Heights", 
                                           "Hopewell", "Prince George", "New Kent", 
                                           "Charles City", "King William", "King and Queen", 
                                           "Essex", "Middlesex", "Gloucester", "Mathews", "Richmond", 
                                           "James City", "Charles City","King George", "Westmoreland", 
                                           "Northumberland", "Lancaster", "Northampton", "Accomack", 
                                           "York", "Williamsburg", "Newport News", "Poquoson", 
                                           "Hampton", "Sussex", "Surry", "Southampton", "Isle of Wight", 
                                           "Suffolk", "Chesapeake", "Virginia Beach", 
                                           "Norfolk", "Portsmouth", "Nelson", "Bath", "Alleghany", 
                                           "Greene", "Orange")),
                      data.frame(state = "MD", 
                                 conam = c("Caroline", "Dorchester", "Wicomico", "Somerset", "Worcester" 
                                           )),
                      data.frame(state = "AZ", 
